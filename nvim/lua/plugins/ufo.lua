return {
	{
		...
		config = function()
			...
			local handler = function(virtText, lnum, endLnum, width, truncate)
				local newVirtText = {}
				local suffix = (" 󰁃 %d lines "):format(endLnum - lnum)
			...
			vim.keymap.set("n", "zn", ufo.goNextClosedFold, { desc = "Next closed fold (UFO)" })
			vim.keymap.set("n", "zN", ufo.goPreviousClosedFold, { desc = "Next closed fold (UFO)" })
