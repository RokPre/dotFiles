...
function M.open()
  ...
  vim.api.nvim_create_autocmd("BufEnter", {
    callback = function()
      if homepage_win and vim.api.nvim_win_is_valid(homepage_win) and vim.api.nvim_win_get_buf(homepage_win) ~= homepage_buf then
...
M.set_keys({
  ...
  { icon = "󰊔 ", key = "h", desc = "Close", action = function() vim.cmd(":try | b# | catch | ;") end },
...
vim.keymap.set("n", "<Leader>h", function() M.open() end, { noremap = true, silent = true })
