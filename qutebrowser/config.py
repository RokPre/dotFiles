...
# Type: QssColor
c.colors.completion.category.border.bottom = "#a9b1d6"
...
# Type: QtColor
c.colors.completion.category.fg = "#a9b1d6"
...
# Type: QssColor
c.colors.completion.item.selected.bg = "#3d59a1"

# Bottom border color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.border.bottom = "#3d59a1"

# Top border color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.border.top = "#3d59a1"
...
# Type: QssColor
c.colors.completion.odd.bg = "#232430"
...
# Type: QtColor
c.colors.hints.match.fg = "#ee88ff"
...
config.bind("<Return>", "selection-follow")
config.bind("<Alt-Ctrl-h>", "back")
config.bind("<Alt-Ctrl-l>", "forward")
config.bind("ba", "bookmark-add")
config.bind(";", "search-prev")
config.bind("Sh", "history")
config.bind("Sq", "bookmark-list")
# config.bind("<Alt-w>", "tab-only")
config.bind("gC", "tab-clone")
...
config.bind("qd", "cmd-set-text -s :quickmark-del ")
...
# Fake split
config.bind('<Alt-s>', 'spawn --userscript fake_split')
